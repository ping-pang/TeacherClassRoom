...
//        self.textColor = TTCOLOR_RGB(150, 150, 150);
        self.textColor = [UIColor colorWithRed:150 green:150 blue:150 alpha:1];
    }
    else {
...
- (void) setTextColor:(UIColor *)textColor {
    if ([self.realText isEqualToString:self.placeholder]) {
        if ([textColor isEqual:[UIColor colorWithRed:150 green:150 blue:150 alpha:1]]) [super setTextColor:textColor];
